...
//HAPUS DATA
  ...
  $_GET['hapus']; 
  mysqli_query($koneksi, "DELETE FROM buku WHERE id=$id"); header("Location: index.php"); 
} 
?>
...
<html lang="en">
  ...
  <tbody>
    <?php $no = 1; while ($buku = mysqli_fetch_assoc($result)) : ?> <tr> 
      <td><?= $no++; ?></td> 
